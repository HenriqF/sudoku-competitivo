...
public class Program
{
    ...
    {
        string pop_users_json = File.ReadAllText("pop.json");
        List<PopUsuario> pop_users = JsonSerializer.Deserialize<List<PopUsuario>>(pop_users_json)!;
